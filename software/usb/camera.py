...
def init_cameras():
    ...
    if cam0_model == "6366" and cam1_model == "0261":
        left_cam = cam0
        right_cam = cam1
    elif cam1_model == "6366" and cam0_model == "0261":
        left_cam = cam1
        right_cam = cam0
    else:
    ...
    left_cam.set(cv2.CAP_PROP_EXPOSURE, 17)
    right_cam.set(cv2.CAP_PROP_EXPOSURE, 3)

    left_cam.set(cv2.CAP_PROP_BUFFERSIZE, 1)
    right_cam.set(cv2.CAP_PROP_BUFFERSIZE, 1)

    left_cam.set(cv2.CAP_PROP_SATURATION, 110)
