...
//static_assert(!any_enable_overlap(), "There is some overlap.");
  ...
  typedef uint32_t shaping_time_t;
...
class Stepper {
  ...
  private:
    ...
    static uint32_t acceleration_time, deceleration_time; // Time measured in Stepper Timer ticks
      ...
      static uint32_t time_spent_in_isr, time_spent_out_isr;
    #endif
    ...
    static uint32_t advance_divisor,
      ...
      static constexpr uint32_t LA_ADV_NEVER = HAL_TIMER_TYPE_MAX;
      ...
      static constexpr uint32_t BABYSTEP_NEVER = HAL_TIMER_TYPE_MAX;
  ...
  public:
    ...
    static void isr();
      ...
      static void advance_isr();
        ...
        static uint32_t smooth_lin_adv_isr();
        #if ENABLED(S_CURVE_ACCELERATION)
  ...
  private:
    ...
    static void _set_position(const abce_long_t &spos);
      ...
      static uint32_t calc_multistep_timer_interval(uint32_t step_rate);
